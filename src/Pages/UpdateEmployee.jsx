...
class UpdateEmployee extends Component {
    ...
    componentDidMount(){
        EServer.getEmployeeById(this.state.id).then((res) =>{
    ...
    updateEmployee =(e) =>{
        ...
        EServer.updateEmployee(employee, this.state.id).then(res => {
                        ...
                        <div className='card col-m-6 offset-md-3 offset-md-3'>
                            ...
                            <div className='card-body'>
                                <form>
                                    ...
                                    <button type="button" class="btn btn-success" onClick={this.updateEmployee}> Update </button>
